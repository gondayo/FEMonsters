...
$(function(){
 ...
 $("#modal-open").click(function(){
      ...
      $("body").append('<div id="modal-main3"><p id="checkwrite">経験値とおかねは獲得できません。</p><p id="checkwrite2">MAPへ戻りますか？</p><input id="yesClick" type="image"src="../../../PICTURE/yesbutton.png" value="d"><br><input id="noClick" type="image"src="../../../PICTURE/nobutton.png" value="f"></div>');
