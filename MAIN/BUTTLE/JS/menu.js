...
$(function(){
 ...
 $("#modal-open").click(function(){
      ...
      $("body").append('<div id="modal-main3"><p id="checkwrite">経験値とお金は獲得できません。</p><p id="checkwrite2">MAPへ戻りますか？</p><form action="retire.php" method="POST"><input id="yesClick" name="yesClick"type="image" src="../../../PICTURE/yesbutton.png"value=""></form><br><input id="noClick" type="image"src="../../../PICTURE/nobutton.png" value="f"></div></form>');
